...
{
    [MovedFrom("UnityEditor.Rendering.LWRP.ShaderGUI")] public static class PBLitGUI
    {
        ...
        public static class Styles
        {
            ...
            public static GUIContent heightFogStartText = new GUIContent("Height Fog Start", "Start range for Height Fog measured in meters on Z axis");
            public static GUIContent heightFogEndText = new GUIContent("Height Fog End", "End range for Height for measured in meters on the Z axis");
            public static GUIContent heightFogColorText = new GUIContent("Height Fog Color", "Height Fog Override Color");
        }
        ...
        public struct LitProperties
        {
            ...
            public MaterialProperty heightFogStartProp;
            public MaterialProperty heightFogEndProp;
            public MaterialProperty heightFogColorProp;
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                heightFogStartProp = BaseShaderGUI.FindProperty("_HeightFogStart", properties, false);
                heightFogEndProp = BaseShaderGUI.FindProperty("_HeightFogEnd", properties, false);
                heightFogColorProp = BaseShaderGUI.FindProperty("_HeightFogColor", properties, false);
            }
        }
        ...
        public static void Inputs(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            //DoHeightFogArea(properties, materialEditor);
        }
        ...
        public static void DoHeightFogArea(LitProperties properties, MaterialEditor materialEditor)
        {
            //materialEditor.FloatProperty(properties.heightFogStartProp, "Height Fog Start");
            materialEditor.ShaderProperty(properties.heightFogStartProp, Styles.heightFogStartText);
            materialEditor.ShaderProperty(properties.heightFogEndProp, Styles.heightFogEndText);
            materialEditor.ShaderProperty(properties.heightFogColorProp, Styles.heightFogColorText);
        }
