...
Shader "Distant Lands/Cozy/Stylized Clouds Desktop"
{
	Properties
	{
		...
		[HideInInspector]_DetailAmount("Detail Amount", Float) = 15
		...
		[HideInInspector]_CirrostratusMoveSpeed("Cirrostratus Move Speed", Float) = 0.5
		...
		[HideInInspector]_CirrusMoveSpeed("Cirrus Move Speed", Float) = 0.5
		_CirrusTexture("Cirrus Texture", 2D) = "white" {}
		[HideInInspector]_ChemtrailsMultiplier("Chemtrails Multiplier", Range( 0 , 2)) = 1
		[HideInInspector]_ChemtrailsMoveSpeed("Chemtrails Move Speed", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float clampResult662 = clamp( ( ( _CirrostratusMultiplier + 2.0 ) * 0.25 ) , 0.0 , 0.98 );
				float CirrostratLightTransport641 = ( ( CirrostratPattern634 * saturate( (0.4 + (dotResult630 - 0.0) * (2.0 - 0.4) / (0.1 - 0.0)) ) ).r > ( 1.0 - clampResult662 ) ? 1.0 : 0.0 );
...
/*ASEBEGIN
Version=18934
0;1080;2194.286;607.5715;1785.749;871.2938;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;605;3238.901,1879.241;Inherit;False;1600.229;583.7008;Final;14;641;639;638;637;636;633;632;630;629;625;642;658;659;662;;0.4588236,0.584294,1,1;0;0
...
Node;AmplifyShaderEditor.ClampOpNode;662;4056.697,2285.228;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.98;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-3370.048,-3982.888;Half;False;Property;_SunFlareFalloff;Sun Flare Falloff;7;1;[HideInInspector];Create;True;0;0;0;False;0;False;1;19.31;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;638;4200.029,2287.771;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;744;6069.037,-466.4966;Inherit;False;Property;_StormDirection;Storm Direction;21;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0,0;-0.7846811,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;659;3802.939,2288.294;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;658;3916.526,2289.384;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;260;-3865.421,-3964.893;Inherit;False;Global;CZY_SunDirection;CZY_SunDirection;6;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0,0;0.5193766,0.8516705,-0.07003719;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;606;3255.498,1361.34;Inherit;False;Property;_CirrostratusMoveSpeed;Cirrostratus Move Speed;26;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;665;6202.655,-2272.49;Inherit;False;Property;_CirrusMoveSpeed;Cirrus Move Speed;29;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.5;0.503;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;375;-2588.193,-4479.109;Inherit;False;Property;_CumulusCoverageMultiplier;Cumulus Coverage Multiplier;12;2;[HideInInspector];[Header];Create;True;1;Cumulus Clouds;0;0;False;0;False;1;0.818;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;571;3588.306,-2275.23;Inherit;False;Property;_ChemtrailsMoveSpeed;Chemtrails Move Speed;32;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.5;0.503;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;499;996.4494,2236.662;Inherit;False;Property;_AltocumulusMultiplier;Altocumulus Multiplier;22;2;[HideInInspector];[Header];Create;True;1;Altocumulus Clouds;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;632;3538.027,2286.771;Inherit;False;Property;_CirrostratusMultiplier;Cirrostratus Multiplier;25;2;[HideInInspector];[Header];Create;True;1;Cirrostratus Clouds;0;0;False;0;False;1;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;698.9319,344.7032;Inherit;False;Property;_DetailAmount;Detail Amount;14;1;[HideInInspector];Create;True;0;0;0;False;0;False;15;30;0;0;0;1;FLOAT;0
...
WireConnection;799;2;352;0
ASEEND*/
//CHKSM=B0C406B8CF5B56C39CAB517379C61CF5988D71EC